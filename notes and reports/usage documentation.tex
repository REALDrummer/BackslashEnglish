...
\newcommand{\codearg}[1]{\codespecial{<}\texttt{#1}\codespecial{>}}
...
\obeylines												% makes line breaks occur in the document as they occur in code
...
% TODO: change to a special form of if statement with a partially applied operator
